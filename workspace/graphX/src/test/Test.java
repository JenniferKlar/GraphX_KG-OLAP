...
import graphX.GraphGenerator2;
import graphX.NQuadReader;
import graphX.NQuadReader2;
...
//	
	...
	public void testPivot() {
		...
		Graph<Object, Relation> pivotGraph = NQuadReader2.pivot(graph, jsc, objectTag, relationTag, "hasLocation",
...
//		NQuadReader2.reify(graph, jsc, objectTag, relationTag,
//				contexts, 
...
//		Graph<Object, Relation> resultGraph = NQuadReader2.groupByProperty(graph, jsc, objectTag, relationTag,
...
//		 = NQuadReader2.replaceByGrouping(graph, jsc, objectTag, relationTag,"ManoeuvringAreaUsage", "usageType", contexts);
//		 
...
//		 = NQuadReader2.replaceByGrouping(graph, jsc, objectTag, relationTag,"AircraftCharacteristic", "wingspanInterpretation", contexts);
////		replacedGraph.triplets().toJavaRDD().foreach
////		(x -> System.out.println(x.srcAttr() + " " + x.attr().getRelationship() + " " + x.dstAttr()+ " " + x.attr().getContext()));
// 
//		
//		Graph<Object, Relation> wingspanSum = NQuadReader2.aggregatePropertyValues(replacedGraph, jsc, objectTag, relationTag, 
...
//		
//		Graph<Object, Relation> wingspanSum = NQuadReader2.aggregatePropertyValues(replacedGraph, jsc, objectTag, relationTag, 
//				 "http://example.org/kgolap/object-model#wingspan", contexts, "COUNT"); 
//		 wingspanSum.triplets().toJavaRDD().foreach
//			(x -> System.out.println(x.srcAttr() + " " + x.attr().getRelationship() + " " + x.dstAttr()+ " " + x.attr().getContext()));
...
//		contexts.add("urn:uuid:cca945a9-1aa3-41ef-86ba-72074cc46b86test-mod"); 
//		Graph<Object, Relation> replacedGraph 
//		 = NQuadReader2.groupByProperty(graph, jsc, objectTag, relationTag,"http://example.org/kgolap/object-model#wingspanInterpretation", "http://example.org/kgolap/object-model#grouping", contexts);
//		 Graph<Object, Relation> resultGraph = NQuadReader2.aggregatePropertyValues(replacedGraph, jsc, objectTag, relationTag, 
//		"http://example.org/kgolap/object-model#wingspan", contexts, "SUM"); 
//		 
...
//		contexts.add("urn:uuid:cca945a9-1aa3-41ef-86ba-72074cc46b86test-mod");
//		Graph<Object, Relation> replacedGraph 
//		 = NQuadReader2.groupByProperty(graph, jsc, objectTag, relationTag,"http://example.org/kgolap/object-model#wingspanInterpretation", "http://example.org/kgolap/object-model#grouping", 
//				 contexts);
//		 Graph<Object, Relation> resultGraph = NQuadReader2.aggregatePropertyValues(replacedGraph, jsc, objectTag, relationTag, 
//		"http://example.org/kgolap/object-model#wingspan", contexts, "COUNT"); 
//		 
